 ...
 * @author Steve
 */
public class NormalGUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        paramDesvTextField = new javax.swing.JTextField();
        desvValidador = new validadores.api.ValidadorJTextComponent();
        ...
        jLabel2.setText("<html>Desviacion<br>Estandar</html>");
                ...
                .addGroup(parametrosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(parametrosPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(parametrosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(paramDesvTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(parametrosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(parametrosPanelLayout.createSequentialGroup()
                                .addGroup(parametrosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(mediaValidador, javax.swing.GroupLayout.DEFAULT_SIZE, 416, Short.MAX_VALUE)
                                    .addComponent(desvValidador, javax.swing.GroupLayout.DEFAULT_SIZE, 416, Short.MAX_VALUE))
                                .addGap(30, 30, 30))
                            .addGroup(parametrosPanelLayout.createSequentialGroup()
                                .addComponent(observacionesValidador, javax.swing.GroupLayout.DEFAULT_SIZE, 436, Short.MAX_VALUE)
                                .addContainerGap())))
                    .addGroup(parametrosPanelLayout.createSequentialGroup()
            ...
            .addGroup(parametrosPanelLayout.createSequentialGroup()
                ...
                .addGroup(parametrosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(parametrosPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(paramDesvTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, parametrosPanelLayout.createSequentialGroup()
                        .addGroup(parametrosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(parametrosPanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(desvValidador, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void simularButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simularButtonActionPerformed
        if (validadorFormulario.validar()) {
            ...
            double desv = Double.parseDouble(paramDesvTextField.getText());
            int observaciones = Integer.parseInt(paramObservacionesTextField.getText());

            Normal norm = new Normal();
            double[] datos = norm.getObservaciones(observaciones,media,desv);
    ...
    private validadores.api.ValidadorJTextComponent desvValidador;
    ...
    private javax.swing.JTextField paramDesvTextField;
